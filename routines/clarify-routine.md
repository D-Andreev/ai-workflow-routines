...
1. **Start** — **session comment** with session URL. Initialize artifacts **in this session only**. Swap to `workflow:clarify`, then ask the first question. **No handoff comment yet.**
